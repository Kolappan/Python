...
bygenre_df = pd.read_csv("UnsupervisedAlgorithms/ContentBasedFiltering/data/content_bygenre_df.csv")
...
# ---------------------------------------------------------------------------
# scale training data - Feature Scaling 
# ---------------------------------------------------------------------------
...
# Use mean squared error loss and Adam optimisation for training
tf.random.set_seed(1)
