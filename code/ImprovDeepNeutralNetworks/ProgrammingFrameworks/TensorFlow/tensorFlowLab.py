...
train_dataset = h5py.File('code/ImprovDeepNeutralNetworks/ProgrammingFrameworks/TensorFlow/datasets/train_signs.h5', "r")
test_dataset = h5py.File('code/ImprovDeepNeutralNetworks/ProgrammingFrameworks/TensorFlow/datasets/test_signs.h5', "r")
...
""" Print the labels in the training set """
unique_labels = set()
